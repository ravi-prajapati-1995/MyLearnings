...
public class SearchIn2DMatrix {
    public static void main(String[] args) {
        ...
        System.out.println(searchMatrixOptimal(matrix, 16));
    }
     ...
     * Question: How we will find row and colum as we will have only mid like for first time we have mid = (0+11)/2 = 5 --> arr[5] = 11
     ...
     *
     * colum: mid%numbers of colums --> 5%4 = 1 same reason every row has 4 elements remaining numbers will give us column so
    ...
    public static boolean searchMatrixOptimal(int[][] matrix, int target) {
        ...
        int row = high/columns;
        int col = high % columns;
